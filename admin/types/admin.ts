// types/admin.ts - Updated with Message and Conversation Types
...
export interface DashboardStats {
  ...
  message_growth_chart: ChartData[]
  top_hashtags: HashtagStats[]
...
export interface ConversationFilter extends BaseFilter {
  type?: 'direct' | 'group'
  created_by?: string
  is_archived?: boolean
  is_muted?: boolean
...
// ==================== UTILITY TYPES ====================
export type EntityType = 'user' | 'post' | 'comment' | 'group' | 'event' | 'story' | 'message' | 'conversation' | 'media'
